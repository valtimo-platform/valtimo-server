...
public class OperatonProcessJsonSchemaDocumentDeploymentService implements ProcessDocumentDeploymentService {
    private static final Logger logger = LoggerFactory.getLogger(OperatonProcessJsonSchemaDocumentDeploymentService.class);
    private final ResourceLoader resourceLoader;
    private final ProcessDocumentAssociationService processDocumentAssociationService;
    private final DocumentDefinitionService documentDefinitionService;
    private final ObjectMapper objectMapper;

    public OperatonProcessJsonSchemaDocumentDeploymentService(
    ...
    private void createProcessDocumentLink(String documentDefinitionName, ProcessDocumentLinkConfigItem item) {
        ...
        AuthorizationContext.runWithoutAuthorization(() -> {
            final var existingAssociationOpt = processDocumentAssociationService.findProcessDocumentDefinition(
                new OperatonProcessDefinitionKey(item.getProcessDefinitionKey())
            );
