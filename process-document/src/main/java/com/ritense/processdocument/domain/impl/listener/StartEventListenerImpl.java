...
public class StartEventListenerImpl implements StartEventListener {
    ...
    @EventListener(condition = "#execution.bpmnModelElementInstance.elementType.typeName == T(org.operaton.bpm.engine.ActivityTypes).START_EVENT " +
    ...
    public void notify(DelegateExecution execution) {
        ...
        if (execution.hasVariable(SOURCE_PROCESS_INSTANCE_ID)) {
            ...
            final var processDefinitionKey = ProcessDefinitionKey.fromExecution(execution, OperatonProcessDefinitionKey.class);
                ...
                if (documentDefinitionId != null) {
                    ...
                    if (sourceDocumentId != null) {
                        var newDocumentRequest = new NewDocumentRequest(
                            ...
                            jsonData
                        ).withDocumentRelation(new DocumentRelationRequest(
                            UUID.fromString(sourceDocumentId.toString()),
