...
public class OperatonProcessJsonSchemaDocumentDefinition
    implements ProcessDocumentDefinition, Persistable<OperatonProcessJsonSchemaDocumentDefinitionId> {

    @EmbeddedId
    private OperatonProcessJsonSchemaDocumentDefinitionId processDocumentDefinitionId;
    ...
    public OperatonProcessJsonSchemaDocumentDefinition(
        final OperatonProcessJsonSchemaDocumentDefinitionId processDocumentDefinitionId,
    ...
    @Override
    public OperatonProcessJsonSchemaDocumentDefinitionId processDocumentDefinitionId() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OperatonProcessJsonSchemaDocumentDefinition)) {
            return false;
        }
        OperatonProcessJsonSchemaDocumentDefinition that = (OperatonProcessJsonSchemaDocumentDefinition) o;
    ...
    @Override
    @JsonIgnore
    public OperatonProcessJsonSchemaDocumentDefinitionId getId() {
        return processDocumentDefinitionId;
    }
