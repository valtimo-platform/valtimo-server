...
//        assertThat(searchFields.get(0).getId().getCaseDefinitionKey()).isEqualTo(documentDefinitionName);
...
//        assertThat(searchFields.get(1).getId().getCaseDefinitionKey()).isEqualTo(documentDefinitionName);
...
//            searchFieldService.createSearchConfiguration(searchFields, CaseDefinitionId.of("house", "1.0.0"));
